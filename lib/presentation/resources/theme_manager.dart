...
ThemeData getApplicationTheme(){
  return ThemeData(
    ...
    textTheme: TextTheme(
      ...
      labelSmall: getBoldStyle(color:ColorManager.primary,fontSize: AppSize.s12 ),
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      enabledBorder:  OutlineInputBorder(
        ...
        borderRadius: BorderRadius.circular(AppSize.s8), // todo remember you modified this radios
      ),
      //focused border
