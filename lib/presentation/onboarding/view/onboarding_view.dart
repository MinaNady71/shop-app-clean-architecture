...
import 'package:flutter_advanced_clean_architecture/presentation/onboarding/view_model/onboarding_viewmodel.dart';
import 'package:flutter_advanced_clean_architecture/presentation/resources/constants_manager.dart';
...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SliderViewObject>(
      stream: _viewModel.outputSliderViwObject,
...
Widget _getContentWidget(SliderViewObject? sliderViewObject){
  ...
  Widget _getProperCircle(index,int currentIndex){
